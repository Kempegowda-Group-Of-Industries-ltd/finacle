...
# Set page configuration - must be the first command
st.set_page_config(
    page_title="Infosys Finacle - Financial Data Analysis with Predictions",
    layout="wide",
    initial_sidebar_state="expanded"
)

# Title and description
st.title("📊 Infosys Finacle - Financial Data Analysis with Future Predictions")
st.write("Welcome to the financial data analysis app. Upload your CSV file to explore your financial data through visualizations, statistics, and future predictions using Machine Learning.")
